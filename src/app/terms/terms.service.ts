...
export class TermsService {
  private userTerms : string =
`These Terms & Conditions set forth how VeganHomies.com, also d.b.a., “Vegan Homies” (herein the “Company”, “we”, “us” or “our”) and you (herein, “you”, “your”, the “user” or “User”) agree to respect and treat each other while and after you are using our website and blog at https://www.VeganHomies.com.

Copyright & Trademark Notice:
Unless otherwise specified, all materials appearing on this site, including the text, site design, logos, graphics, icons, and images, as well as the selection, assembly and arrangement thereof, are the sole property of VeganHomies.com, Copyright © 2019, ALL RIGHTS RESERVED. No materials from this site may be copied, reproduced, modified, republished, uploaded, posted, transmitted, or distributed in any form or by any means without our prior written permission. All rights not expressly granted herein are reserved. Any unauthorized use of the materials appearing on this site may violate copyright, trademark and other applicable laws and could result in criminal or civil penalties.

The Company sometimes accepts forms of cash advertising, sponsorship, paid insertions, or other forms of compensation. We abide by word of mouth marketing standards. We believe in honesty of relationship, opinion and identity. The compensation received may influence the advertising content, topics or posts made in this website and blog. That content, advertising space or post will be clearly identified as paid or sponsored content.

Comunity Standards:
1. Since VeganHomies.com is first and foremost a website designed to allow you to connect with and communicate with other users, by accepting these User Terms and Conditions, you are agreeing to abide by the Community Standards laid out below.  Violation of these standards will result in being temporarily or permanenty banned from the VeganHomies.com.

2. VeganHomies.com is intended for vegans, who are practicing veganism as defined by the Vegan Society as "Veganism is a way of living which seeks to exclude, as far as is possible and practicable, all forms of exploitation of, and cruelty to, animals for food, clothing or any other purpose."  If you are not practicing veganism by the forementioned definition and are attempting to use the site, you are in violation of the Community Standards.

3. The encouragement of violence or criminal behavior will not be tolerated on VeganHomies.com.  Veganism is at it's core a rejection of violence and we believe that it is never an effective way to help non-human animals.  While we acknowledge that what is legal is not always ethical and what is ethical is not always legal, VeganHomies.com does not encourage illegal activities and cannot support those who do so on our platform.

4. Harrassment of other users on the platform of any kind is not allowed. Sending unsolicited sexual messages, hate speach against any group or individual, threatening other users and posting of violent or sexual images are all prohibited activities on VeganHomies.com.

5. No solicitation is allowed on VeganHomies.com.  There are plenty of other platforms to advertise your goods or services on.

Other Terms & Conditions:
All of the terms and conditions of our Privacy Policy are incorporated into these terms and conditions, and vice-versa. We make no guarantees or warranties about any information on our site or blog, including without limitation any warranty of fitness for a particular purpose. Anyone subscribing to our website or blog is also agreeing to these Terms & Conditions.  Any of our subscribers may opt out at any time by reply email, if the email was sent directly by us or one of our staff.  These terms and conditions will supersede any terms and/or conditions you may have copies of in any form, regardless of whether we have signed them or not. We reserve the right to make changes to this site and these terms and conditions at any time. These terms and conditions were last updated effective September 5, 2019.`;

  private privacyPolicy : string =
`Privacy Policy:
1. This Privacy Agreement (also herein, this “Agreement”, also this “Privacy Policy” or “policy”) is entered into by and between VeganHomies.com (herein the “Company”, “we”, “us” or “our”), including our legal successors and assigns, and you. This Agreement also sets forth how we use and protect any information that you give us while you are using VeganHomies.com (herein, this “website” or “site”), any of our information, products and/or services, and/or while communicating with us and certain duties you may have as to us as you use our website, our content and materials. The privacy of our users is very important to us. Should we ask you to provide certain information by which you can be identified when using this website, our products and/or services, then you can be assured that it will only be used in accordance with this Privacy Agreement.

2. Regulatory Matters: Only to the extent the following statutes or rules may be applicable as to this Agreement, to us and to you, the terms of this Agreement, our standard practices and the terms of any other agreement(s) between you and the Company are intended to comply with the terms and rules of the European Union General Data Protection Regulation first effective May 25, 2018, as may be amended (the “GDPR”), and with the terms and rules established by the US Federal Trade Commission (“FTC”), as may be amended, including without limitation the Controlling the Assault of Non-Solicited Pornography And Marketing Act of 2003, as amended (“CAN-SPAM Act”) and the Children’s Online Protection Act of 1998, as amended (“COPA”), and also with the Digital Millennium Copyright Act of 1998 of the United States, as amended, and the rules established by the World Intellectual Property Organization (“WIPO”), as amended (each of the above, a “Regulation, collectively, the “Regulations”). Both parties to this Agreement pledge their best efforts in cooperation with each other, and in their compliance with applicable Regulations, in general and as set forth in this Agreement.

GDPR / FTC NOTICE: Among other means that you may provide us for our communicating with you, you consent and agree to communicate with us via email. If at any time you would like to stop the collection or use of your information by us, you may opt out or unsubscribe by accessing "Account" -> "Preferences" in the site's menu and deselecting the emails you wish to unsubscribe from in the "Email Preferences" section. Keep in mind that unsubscribing or opting out in this manner may result in limitations on your use of our website, in the ongoing receipt of our products or services, in our ability to communicate with you, or in your ability to communicate with us. See Section 11 below for more details.
...
A. We agree that we will not sell, lend, lease or rent your information to third parties. We also agree not to share your information with third parties except as provided in this Agreement; we also may share your information under the following unusual circumstances: (i) we have your permission to do so, (ii) it is clearly probable that you have breached the terms of this Agreement or another agreement we may have with you, or (iii) we are required by applicable law, Regulation, rule or administrative order to do so. We love our users and we hope and believe these feelings are mutual.

B. You agree that a number of the provisions of our Terms & Conditions & User Agreement may affect your privacy; therefore, our Terms & Conditions and User Agreement are incorporated herein by reference. You also agree that you will uphold and respect our complete ownership of our content, trade names and materials, which are more fully defined and described as “Names” and “Materials” in our Terms & Conditions and User Agreement with you, and you agree to fully uphold your duties and obligations to us under our license to you of our Materials as described in that agreement.
...
Legal Template provided by SimplyDoneLegal.com; Copyright © 2015-2018, ALL RIGHTS RESERVED; used here by written permission; last updated September 5, 2019.`;
  ...
  // Gets the full terms and conditions and privacy policy
  getFullUserAgreement() : string{
    return this.userTerms + "\n\n" + this.privacyPolicy;
  }
}
